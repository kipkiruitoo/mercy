...
$supermarket = $_GET['sup'];


// echo $supermarket;
include('dbconnect.php');

$sql = 'Select * from product where supermarket='. $supermarket ;
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php"><span>Super</span> Shopa</a></h1>
			</div>
			...
			<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:mercy.titus@strathmore.edu">mercy.titus@strathmore.edu</a></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<!-- banner -->
	<div class="banner">
		...
		<div class="w3l_banner_nav_right">
			...
			<!-- flexSlider -->
				<link rel="stylesheet" href="admin/css/flexslider.css" type="text/css" media="screen" property="" />
								...
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="/admin/files/<?php echo $row['picture'];?>" /></a>		
											<p><?php echo $row['name'];?></p>
											<h4>Kshs <?php echo $row['price'];?></h4>
										</div>
...
<script>
		...
		var myTemplate = "<div><%= config.strings.subtotal %> <%= cart.total({ format: true, showCode: false }) %></div>";
