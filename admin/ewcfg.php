...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "16.0.4");
...
$CONFIG = [
	...
	"RANDOM_KEY" => '7I43ydetfHSK0nO4', // Random key for encryption
	...
	"PROJECT_ID" => "{DF8AE69E-A8E4-47DE-B52F-615F4E49F3E5}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "shopa"]
	],
