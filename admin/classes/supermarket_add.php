 ...
 * Page class
 */
class supermarket_add extends supermarket
{
	...
	// Page object name
	public $PageObjName = "supermarket_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("supermarketID") !== NULL) {
				...
				$this->setKey("supermarketID", $this->supermarketID->CurrentValue); // Set up key
			} else {
				$this->setKey("supermarketID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "supermarketview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->supermarketID->OldValue = $this->supermarketID->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['supermarketID'] = $this->supermarketID->CurrentValue;
