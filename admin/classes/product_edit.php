...
class product_edit extends product
{
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// amountLeft
			$this->amountLeft->setDbValueDef($rsnew, $this->amountLeft->CurrentValue, 0, $this->amountLeft->ReadOnly);

			// price
			$this->price->setDbValueDef($rsnew, $this->price->CurrentValue, 0, $this->price->ReadOnly);

			// supermarket
			$this->supermarket->setDbValueDef($rsnew, $this->supermarket->CurrentValue, 0, $this->supermarket->ReadOnly);
